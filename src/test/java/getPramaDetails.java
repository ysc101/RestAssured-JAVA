...
public class getPramaDetails {
	@Test
	public void getPramaDetailsforconstructor() {
		...
		requestparam.put("financilYear", "2019-20");
		...
		// Response Object
		Response response = httpRequest.request(Method.GET, "/Prama/GetPramaDetailsByContractorID");
