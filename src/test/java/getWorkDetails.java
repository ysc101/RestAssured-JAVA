...
public class getWorkDetails {
	@Test
	public void getWorkDetailsforcontractor() {
		...
		// Response Object
		Response response = httpRequest.request(Method.GET, "/Work/GetworkOrderDetailsByContractorIDandPramaID");
